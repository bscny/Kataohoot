...
CREATE TABLE `fb_quiz_determination` (
  ...
  CONSTRAINT `fb_quiz_determination_ibfk_1` FOREIGN KEY (`FB_id`) REFERENCES `fill_blank_question` (`FB_id`),
  CONSTRAINT `fb_quiz_determination_ibfk_2` FOREIGN KEY (`Record_id`) REFERENCES `quiz_record` (`Record_id`)
...
CREATE TABLE `fill_blank_question` (
  ...
  PRIMARY KEY (`FB_id`),
  KEY `Quiz_id` (`Quiz_id`),
  CONSTRAINT `fill_blank_question_ibfk_1` FOREIGN KEY (`Quiz_id`) REFERENCES `quiz` (`Quiz_id`)
...
CREATE TABLE `folder` (
  ...
  CONSTRAINT `folder_ibfk_1` FOREIGN KEY (`User_id`) REFERENCES `user` (`User_id`),
  CONSTRAINT `folder_ibfk_2` FOREIGN KEY (`Parent_folder_id`) REFERENCES `folder` (`Folder_id`)
...
CREATE TABLE `quiz` (
  ...
  CONSTRAINT `quiz_ibfk_1` FOREIGN KEY (`Folder_id`) REFERENCES `folder` (`Folder_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `quiz_record` (
  ...
  KEY `User_id` (`User_id`),
  KEY `Quiz_id` (`Quiz_id`),
  CONSTRAINT `quiz_record_ibfk_1` FOREIGN KEY (`User_id`) REFERENCES `user` (`User_id`),
  CONSTRAINT `quiz_record_ibfk_2` FOREIGN KEY (`Quiz_id`) REFERENCES `quiz` (`Quiz_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `single_open_question` (
  ...
  PRIMARY KEY (`SO_id`),
  KEY `Quiz_id` (`Quiz_id`),
  CONSTRAINT `single_open_question_ibfk_1` FOREIGN KEY (`Quiz_id`) REFERENCES `quiz` (`Quiz_id`)
...
CREATE TABLE `so_quiz_determination` (
  ...
  KEY `Record_id` (`Record_id`),
  CONSTRAINT `so_quiz_determination_ibfk_1` FOREIGN KEY (`SO_id`) REFERENCES `single_open_question` (`SO_id`),
  CONSTRAINT `so_quiz_determination_ibfk_2` FOREIGN KEY (`Record_id`) REFERENCES `quiz_record` (`Record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tf_question` (
  ...
  PRIMARY KEY (`TF_id`),
  KEY `Quiz_id` (`Quiz_id`),
  CONSTRAINT `tf_question_ibfk_1` FOREIGN KEY (`Quiz_id`) REFERENCES `quiz` (`Quiz_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tf_quiz_determination` (
  ...
  KEY `Record_id` (`Record_id`),
  CONSTRAINT `tf_quiz_determination_ibfk_1` FOREIGN KEY (`TF_id`) REFERENCES `tf_question` (`TF_id`),
  CONSTRAINT `tf_quiz_determination_ibfk_2` FOREIGN KEY (`Record_id`) REFERENCES `quiz_record` (`Record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-06 11:39:47
